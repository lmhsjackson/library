...
class CheckoutsControllerTest < ActionController::TestCase
  ...
  test "should create checkout" do
    assert_difference('Checkout.count') do
      post :create, checkout: { book_id: @checkout.book_id, end_date: @checkout.end_date, start_date: @checkout.start_date, user_id: @checkout.user_id }
    end
  ...
  test "should update checkout" do
    patch :update, id: @checkout, checkout: { book_id: @checkout.book_id, end_date: @checkout.end_date, start_date: @checkout.start_date, user_id: @checkout.user_id }
    assert_redirected_to checkout_path(assigns(:checkout))
  end
